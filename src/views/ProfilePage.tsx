...
export function ProfilePage() {
  ...
  if (!user) {
    return <ClientRedirect href={loginHref('/perfil')} />
  }
    ...
    <div className="page page--profile">
      ...
      <section className="profile-hero">
        <div className="container profile-hero__grid">
          ...
          <div className="profile-hero__actions">
            <Link href="/planos" className="btn btn-glass">
              Ver planos
            </Link>
            <Link href="/vagas" className="btn btn-glass">
              Ver vagas
            </Link>
      ...
      <div className="container profile-layout">
        ...
        <div className="profile-main">
          <div className="profile-tabs-wrap">
            <div className="profile-tabs" role="tablist" aria-label="Perfil do estudante">
              ...
              <button
                ...
                aria-controls="profile-panel-agenda"
              ...
              <button
                ...
                aria-controls="profile-panel-conquistas"
            ...
            {activeCourses.length === 0 ? (
              ...
              <ul className="profile-course-list">
                {activeCourses.map((c) => {
                  ...
                  return (
                    <li key={c.id}>
                      <Link href={`/curso/${c.id}`} className="profile-course-card">
          ...
          <div
            id="profile-panel-agenda"
            className="profile-tab-panel"
            role="tabpanel"
            aria-labelledby="profile-tab-agenda"
            hidden={profileTab !== 'agenda'}
          >
            <ProfileAgenda userEmail={user.email} />
          </div>

          <div
            id="profile-panel-conquistas"
            className="profile-tab-panel"
            role="tabpanel"
            aria-labelledby="profile-tab-conquistas"
            hidden={profileTab !== 'conquistas'}
          >
      ...
      <section className="profile-hero">
        <div className="container profile-hero__grid">
          ...
          <div className="profile-hero__actions">
            {canRecruit ? (
              <>
                <Link href="/talentos" className="btn btn-glass">
                  Buscar talentos
                </Link>
                <Link href="/empresa/vagas" className="btn btn-glass">
                  Publicar vagas
                </Link>
              </>
            ) : null}
            <Link href="/empresa/assessoria" className="btn btn-glass">
              Contrato / equipe
            </Link>
          </div>
        </div>
          ...
          <section className="info-card">
            ...
            <p className="info-card__para">
              {plan === 'contract_employee' ? (
                ...
                <>
                  Publicações podem aparecer em <Link href="/vagas">Vagas</Link> para perfis estudantes buscarem
          ...
          <section className="info-card">
            ...
            <ul className="enterprise-checklist">
              {canRecruit ? (
                <>
                  <li>
                    <Link href="/talentos">Explorar talentos</Link> na base MotStart.
                  </li>
                  <li>
                    <Link href="/empresa/vagas">Cadastrar uma vaga</Link> com stack e modalidade.
                  </li>
                </>
              ) : (
              ...
              <li>
                <Link href="/empresa/assessoria">Falar com a assistência</Link> para contrato de capacitação em equipe.
              </li>
            </ul>
          </section>
        </div>
